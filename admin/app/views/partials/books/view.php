...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Book Details</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-categories_category_name">
                                        <th class="title"> Category: </th>
                                        <td class="value"> <?php echo $data['categories_category_name']; ?></td>
                                    </tr>
                                    <tr  class="td-author">
                                    ...
                                    <tr  class="td-lend_duration">
                                        ...
                                        <td class="value"> <?php echo $data['lend_duration']; ?></td>
                                    </tr>
                                    ...
                                    <tr  class="td-version">
                                        ...
                                        <td class="value"> <?php echo $data['version']; ?></td>
                                    </tr>
                                    <tr  class="td-year_published">
                                        <th class="title"> Year Published: </th>
                                        <td class="value"> <?php echo $data['year_published']; ?></td>
                                    </tr>
                                    <tr  class="td-thumbnail">
                                        <th class="title"> Thumbnail: </th>
                                        <td class="value"><?php Html :: page_img($data['thumbnail'],100,100,1); ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
