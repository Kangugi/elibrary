                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-categories_category_name"> Category Name</th>
                                                <th  class="td-author"> Author</th>
                                                <th  class="td-publisher"> Publisher</th>
                                                <th  class="td-lend_duration"> Lend Duration</th>
                                                <th  class="td-serial_number"> Serial Number</th>
                                                <th  class="td-version"> Version</th>
                                                <th  class="td-year_published"> Year Published</th>
                                                <th  class="td-thumbnail"> Thumbnail</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-title"><a href="<?php print_link("books/view/$data[book_id]") ?>"><?php echo $data['title']; ?></a></td>
                                                <td class="td-categories_category_name"> <?php echo $data['categories_category_name']; ?></td>
                                                <td class="td-author"> <?php echo $data['author']; ?></td>
                                                <td class="td-publisher"> <?php echo $data['publisher']; ?></td>
                                                <td class="td-lend_duration"> <?php echo $data['lend_duration']; ?></td>
                                                <td class="td-serial_number"> <?php echo $data['serial_number']; ?></td>
                                                <td class="td-version"> <?php echo $data['version']; ?></td>
                                                <td class="td-year_published"> <?php echo $data['year_published']; ?></td>
                                                <td class="td-thumbnail"><?php Html :: page_img($data['thumbnail'],50,50,1); ?></td>
                                            </tr>
                                            <?php 
                                            }
                                            ?>
