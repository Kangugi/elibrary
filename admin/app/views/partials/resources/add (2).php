                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-resource_type"  value="<?php  echo $this->set_field_value('resource_type',""); ?>" type="number" placeholder="Enter Resource Type" step="1"  required="" name="resource_type"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
